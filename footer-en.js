...
footer.innerHTML = `
    ...
    <p><span class="end">Last update : 24 April 2026</span></p>
    <p>
...
text[13]=  "The hamlet of Vacaria seen from the hamlet of Agros";
...
text[81]=  "Serra de Arga seen from Santa Maria de Geraz do Lima";
text[82]=  "View of the heights of Santa Leoc&aacute;dia de Geraz do Lima";
...
text[128]= "Greenery above Saint-Michel-de-Llotes";
...
text[228]= "The Agly River in the Fenouill&egrave;des with Ansignan in background (center)";
...
text[401]= "The hamlet of Savenac with Bestiac in background (left)";
...
text[406]= "Bestiac surroundings and the Ari&egrave;ge valley around Luzenac (left)";
text[407]= "Saint-Barth&eacute;lemy and Soularac summits and the Trimouns Talc Mine seen from the road to the Col de Marmare";
...
text[859]= "Scenery of the Volvestre seen near M&eacute;ras with the Pyrenees (Mont Valier at the center) in background";
text[860]= "Relief of the Volvestre near M&eacute;ras and the Montcalm Massif";
text[861]= "Landscape and greenery of the south of M&eacute;ras with the Pyrenees (Mont Valier at the center) in background";
...
text[865]= "View from the north of Latour towards the Pyrenees (Mont Valier at the center)";
...
text[868]= "Scenery of the area between Latour and Bax in front of the Pyrenees (Mont Valier at the center)";
...
text[1021]="Scenery of the Plateau de Beille towards Andorra";
...
text[1184]="Fields near Unzent with the Pyrenees in background (Mont Valier at the center)";
...
text[1202]="Landscape near Esperce, towards Saint-Ybars";
text[1203]="Fields near Saint-Ybars and the Pyrenees far away (Mont Valier at the center)";
text[1204]="Scenery around Saint-Ybars with the Pyrenees in background";
text[1205]="View of Castagnac and surrounding fields";
text[1206]="Greenery of the Terrefort ari&eacute;geois seen from above Massabrac";
...
text[1221]="Saint-Savin, in the Lavedan";
text[1222]="Horses, Saint-Savin and villages of the Davant-Aiga far away";
...
text[1257]="Scenery of the S&eacute;gala seen from Crespin";
text[1258]="Cows and greenery near Crespin";
text[1259]="Landscape seen from the road between Crespin and Moular&egrave;s";
text[1260]="A lake near Moular&egrave;s and a view towards the area of Carmaux";
text[1261]="Fields seen on the road between Vieillevigne and Gardouch with the Pyrenees in background";
text[1262]="Saint-Sabin church of Blanquefort and its environment";
text[1263]="Fields seen on the road between Saint-Sauvy and Augnax";
text[1264]="Fields towards Lucvielle";
text[1265]="Landscape around Castelnau-Barbarens";
text[1266]="Sinsat in the Ari&egrave;ge valley (bottom) seen from the road to Larnat";
text[1267]="Greenery around Larnat, in summer";
text[1268]="Les Cabannes (center) and the Ch&acirc;teau de Gudanes (right) ssen from the road to Larcat";
text[1269]="Greenery of the Fenouill&egrave;des seen on the road to Prats-de-Sournia, with the Canigou in background (right)";
text[1270]="Prats-de-Sournia and its surroundings";
text[1271]="View over the area of Feilluns from near Prats-de-Sournia";
...
text[1313]="Croix des Cabannes in front of the medieval city of Cordes-sur-Ciel";
text[1314]="Scenery of the area of Cordes-sur-Ciel seen near Saint-Antoine-de-Corrompis church";
text[1315]="Greenery of the north of Cordes-sur-Ciel seen from the top of the medieval city";
...
text[1348]="Cows and the tower of the Th&eacute;mis solar power plant in Cerdanya";
text[1349]="View near the Th&eacute;mis solar power plant with the Campcard&oacute;s massif far away (left)";
text[1350]="Landcape near the Th&eacute;mis solar power plant with Serra del Cad&iacute; (left) and Campcard&oacute;s massif (center)";
text[1351]="Scenery of Cerdanya near Targasonne with Serra de Moixer&oacute; (left) and Serra del Cad&iacute; (right) far away";
text[1352]="View of the Puigmal massif near Targasonne";
text[1353]="Cerdanya seen near the Th&eacute;mis solar power plant with &Eacute;gat and the Pic de Gallinas in background";
text[1354]="&Eacute;gat, its tower and its environment in Cerdanya";
...
text[1363]="Argel&egrave;s-Plage (left) and Collioure (right) seen near the Col de Mollo";
text[1364]="Landscape around Collioure and the Fort Saint-Elme seen near the Col de Mollo";
text[1365]="View towards Port-Vendres (center) and the Fort Saint-Elme (left) from near the Mirador de Madeloc";
...
text[1380]="Fields between Mauvaisin and Aignes with the Pyrenees in background (Mont Valier at the center)";
text[1381]="Landscape towards Tabe massif seen from Gaudi&egrave;s";
...
text[1390]="Santa Leoc&aacute;dia de Geraz do Lima church and its environment";
...
text[1398]="View towards Poiares' church with Balug&atilde;es' area in background";
...
text[1404]="The Lima, Lanheses and Serra de Arga seen from the heights of Santa Leoc&aacute;dia de Geraz do Lima";
...
text[1413]="The Lima and Serra de Arga seen from Lanheses' bridge";
...
text[1416]="The Atlantic Ocean seen from Santa Luzia sanctuary, above Viana do Castelo";
...
text[1424]="Saint-Michel de Cours and its surroundings";
text[1425]="View towards the Rauze Viaduct and Nadillac from Saint-Michel de Cours";
...
text[1453]="View towards Ourdon (center) from near Gazost";
...
text[1474]="Summits of the south of the Luchonnais seen from Saint-Mamet";
text[1475]="Luchon-Superbagn&egrave;res ski resort seen from Montauban-de-Luchon";
text[1476]="Luchon valley and the south of the Luchonnais seen from near Antignac";
text[1477]="View from Luchon valley to summits of the Luchonnais from the road to Gouaux-de-Luchon";
text[1478]="Saint-Pierre-Saint-Paul church of Artigue and its environment";
text[1479]="Landcape of Artigue in the Luchonnais";
text[1480]="Scenery of the Luchonnais seen from Artigue";
text[1481]="Moustajon and Bagn&egrave;res-de-Luchon (bottom) and summits of the Luchonnais seen from Artigue";
...
text[1520]="View over Larboust valley from Les Agudes ski resort";
text[1521]="Larboust valley and Gouaux-de-Larboust (bottom-center) seen from Les Agudes ski resort";
text[1522]="Les Agudes ski resort and its environment in summer";
text[1523]="View around the road to Les Agudes ski resort";
text[1524]="Landscape of Larboust valley near Gouaux-de-Larboust (center)";
text[1525]="A street of Gouaux-de-Larboust and Les Agudes in background (top-center)";
text[1526]="Saint-Exup&egrave;re church of Gouaux-de-Larboust and its surroundings";
...
text[1545]="Sunflower field and the Garran&eacute; church";
text[1546]="Garran&eacute; castle and its environment in Seissan";
...
text[1613]="Cows in the Terrefort ari&eacute;geois near Durfort";
text[1614]="Fields around Marliac with the Pyrenees in background";
text[1615]="Landscape of the Terrefort ari&eacute;geois in Durfort and the Pyrenees";
text[1616]="Ruins of Durfort castle";
text[1617]="Scenery of the Terrefort ari&eacute;geois near Durfort with the Pyrenees in background";
text[1618]="Greenery between Durfort and Esplas with Mont Valier far away (center)";
text[1619]="View of the Terrefort ari&eacute;geois near Esplas with the Pyrenees in background";
text[1620]="Saint-Anastase church surrounded by Saint-Martin-d'Oydes' houses";
text[1621]="Fields around Montmaur (in background) from the road to Mourvilles-Hautes";
...
text[1637]="Mont Saint-Loup seen between Agde and Marseillan-Plage";
text[1638]="View near Marseillan-Plage with the Mont Saint-Clair far away (center)";
text[1639]="View over Corneilhan in winter";
text[1640]="Vines and the Albera massif seen near Baho";
text[1641]="Landscape between Baho and Baixas with Canigou massif, Madr&egrave;s massif and For&ccedil;a R&eacute;al";
text[1642]="Scenery of Ansignan and its ancient aqueduct over the Agly River";
text[1643]="Vines, Caramany lake and Caramany village (right) in the Fenouill&egrave;des";
text[1644]="Lapeyr&egrave;re and its surroundings";
text[1645]="Landcape of the Volvestre and the Pyrenees seen near Lapeyr&egrave;re";
text[1646]="Fields and Saint-Ybars (right) seen near Massabrac";
...
text[1667]="Landscape from Geraz do Lima to Serra de Arga (left) from the hamlet of Costa";
...
text[1675]="Calvary of Montaria and a cork oak";
...
text[1685]="Trees around the road between Gramond and Boussac";
text[1686]="Cows in Manhac with the hamlet of Les Garrigues in background";
...
text[1716]="Greenery seen from Labessi&egrave;re-Candeil";
text[1717]="Landscape towards Puybegon (center, far away)";
text[1718]="Scenery around Saint-Sigismond church of Puybegon";
text[1719]="Fields near Lapenche with Puylaroque far away (center)";
text[1720]="Saint-Cevet church and its surroundings in Fontanes";
text[1721]="View over the Lot and Cahors";
text[1722]="Scenery of the Valentr&eacute; Bridge in Cahors";
...
<div class="${isLarge[i] ? "picture__block--large" : "picture__block"}">
    ...
    <div class="${isLarge[i] ? "picture--large" : "picture"}"
        ...
        <div class="caption">
            <a href="https://maps.google.com/maps?f=q&hl=en&q=${latitudeLongitude[i]}" target="_blank" rel="noopener noreferrer">
                ${text[i]}
            </a>
        </div>
    </div>
